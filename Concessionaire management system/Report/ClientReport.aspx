<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ClientReport.aspx.vb" Inherits="Concessionaire_management_system.ClientReport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Text="Client Report" CssClass="title"></asp:Label>
        <table class="rep">
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1194px" Font-Names="Verdana" ToolbaritemborderWidth ="1px" ToolbaritemPressedBorderstyle="Solid" 
                        ...
                        <LocalReport ReportPath="Report\RptCustomer.rdlc">
                            <DataSources>
